...
Server bundle: ~110 KB gzipped on Cloudflare Workers, ~160 KB gzipped on Node. Browser client: ~5 KB gzipped. The whole public API fits in a single ~12k-token `dist/API.md` — small enough that an LLM can hold it in context.
