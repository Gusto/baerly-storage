...
| `node scripts/lint-package-layers.mjs`                                  | enforces the package import allow list (`docs/contributing/architecture.md` §Package layers, which also carries the rationale). Runs as part of `pnpm verify`.                                                                                                                                                                                                                                                                                                                                                                                    | ~ms                                  | ✅                                                                                                                                                                    |
